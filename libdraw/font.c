...
int
cachechars(Font *f, const char **ss, const Rune **rr, ushort *cp, int max, int *wp, const char **subfontname)
{
...
int
loadchar(Font *f, Rune r, Cacheinfo *c, int h, int noflush, const char **subfontname)
{
