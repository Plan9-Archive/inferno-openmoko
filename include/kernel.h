...
extern	long	kpread(int, char*, long, vlong);
extern	long	kread(int, char*, long);
extern	int	    kremove(char*);
extern	vlong	kseek(int, vlong, int);
extern	int	    kstat(char*, char*, int);
extern	int	    kunmount(char*, char*);
extern	long	kpwrite(int, const char*, long, vlong);
extern	long	kwrite(int, const char*, long);
extern	int	    kwstat(char*, char*, int);
extern	int     klisten(__in_z const char *dir, 
