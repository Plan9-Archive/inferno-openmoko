...
{
    char*   name;
    const char*   (*fn)(TkTop*, __in_z const char*, char**);
};
...
Tk*
tklook(TkTop *t, __in_z const char *wp, int parent)
{
    Tk *f;
    char *p, *q;
...
void
tktextsdraw(__in_ecount(1) const Image *img, Rectangle r, TkEnv *e, int sbw)
{
    Image *l, *d;
    Rectangle s;
...
void
tkbox(__in_ecount(1) const Image *i, Rectangle r, int bd, Image *fill)
{
    if (bd > 0) {
...
void
tkbevel(__in_ecount(1) const Image *i, Point o, int w, int h, int bw, __in_ecount(1) const Image *top, __in_ecount(1) const Image *bottom)
{
    Rectangle r;
    int x, border;
 ...
 */
void
tkdrawrelief(__in_ecount(1) const Image *i, Tk *tk, Point o, int color, int rlf)
{
    TkEnv *e;
    Image *l, *d, *t;
    int h, w, bd, bd1, bd2;
...
Point
tkstringsize(Tk *tk, __in_z const char *text)
{
    char *q;
    int locked;
    Display *d;
...
static const char*
tkul(__in_ecount(1) const Image *i, 
     Point o, 
     __in_ecount(1) const Image *col, 
     int ul, 
     Font *f, 
     __in_z const char *text)
{
    char c;
    char *v;
    Rectangle r;
...
const char*
tkdrawstring(Tk *tk, __in_ecount(1) const Image *i, Point o, __in_z const char *text, int ul, __in_ecount(1) const Image *col, int j)
{
    int n, l, maxl, sox;
    char *q;
    const char *txt;
...
static void
tkcancela(TkAction **l, int event, int type, __in_z const char *arg)
{
    TkAction *a;
...
const char*
tkaction(TkAction **l, int event, int type, __in_z const char *arg, int how)
{
    TkAction *a;
...
const char*
tkitem(char *buf, __in_z const char *a)
{
    char *e;
...
static const char*
tkunits(char c, __inout_ecount(1) int *d, TkEnv *e)
{
    switch(c) {
    default:
        if(c >= '0' || c <= '9' || c == '.')
 ...
 */
const char*
tkfrac(__inout const char **arg, int *f, TkEnv *env)
{
...
const char*
tkfracword(TkTop *t, __inout const char **arg, int *f, TkEnv *env)
{
    const char *p;
    char buf[Tkminitem];
...
static const char*
tkwidgetcmd(TkTop *t, Tk *tk, __in_z const char *arg, __inout_ecount_opt(1) char **val)
{
    TkMethod *cm;
    TkCmdtab *ct;
    int bot, top, new, r;
...
static const char*
tksinglecmd(TkTop *t, __in_z const char *arg, __inout_ecount_opt(1) char **val)
{
    Tk *tk;
    int bot, top, new;
    const char *e;
...
static const char*
tkmatch(int inc, int dec, __in_z const char *p)
{
    int depth, esc, c;
...
const char*
tkexec(TkTop *t, __in_z const char *arg, char **val)
{
    int cmdsz, n;
    const char *p, *e;
    char *cmd, *c;
...
void
tkerr(TkTop *t, __in_z const char *e)
{
    if(t != nil && e != nil){
