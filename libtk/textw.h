...
extern	const char*	tktaddmarkinfo(TkText*, __in_z const char*, TkTmarkinfo**);
extern	const char*	tktaddtaginfo(Tk*, __in_z const char*, TkTtaginfo**);
...
extern	const char*	tktextcursor(Tk*, __in_z const char*, char **);
extern	Tk*		    tktextevent(Tk*, int, void*);
extern	Tk*		    tktinwindow(Tk*, Point*);
extern	const char*	tktextselection(Tk*, __in_z const char*, char**);
extern	void		tktextsize(Tk*, int);
extern	TkTmarkinfo*tktfindmark(TkTmarkinfo*, __in_z const char*);
extern	int		    tktfindsubitem(Tk*, TkTindex*);
extern	TkTtaginfo*	tktfindtag(TkTtaginfo*, __in_z const char*);
extern	const char* tktfixgeom(Tk*, TkTline*, TkTline*, int);
...
extern	const char* tktinsert(Tk*, TkTindex*, __in_z const char*, TkTitem*);
extern	int	        tktisbreak(int);
extern	void		tktitemind(TkTitem*, TkTindex*);
extern	const char* tktiteminsert(TkText*, TkTindex*, TkTitem*);
extern	TkTline*	tktitemline(TkTitem*);
extern	__checkReturn const char* tktindparse(Tk*, __inout_ecount_full(1) const char**, TkTindex*);
extern	TkTitem*	tktlastitem(TkTitem*);
extern	int		    tktlinenum(TkText*, TkTindex*);
extern	int		    tktlinepos(TkText*, TkTindex*);
extern	int		    tktmarkind(Tk*, __in_z const char*, TkTindex*);
extern	const char* tktmarkmove(Tk*, TkTmarkinfo*, TkTindex*);
extern	const char*	tktmarkparse(Tk*, __inout_ecount_full(1) const char**, TkTmarkinfo**);
extern	int		    tktmaxwid(TkTline*);
extern	const char* tktnewitem(int, int, TkTitem**);
extern	const char* tktnewline(int, TkTitem*, TkTline*, TkTline*, TkTline**);
...
extern	const char* tktsplititem(TkTindex*);
extern	void		tktstartind(TkText*, TkTindex*);
extern	const char*	tkttagchange(Tk*, int, TkTindex*, TkTindex*, int);
extern	int		    tkttagbit(TkTitem*, int, int);
extern	void		tkttagcomb(TkTitem*, TkTitem*, int);
extern	int		    tkttagind(Tk*, __in_z const char*, int, TkTindex*);
...
extern	const char*	tkttagparse(Tk*, __inout_ecount_full(1) const char**, TkTtaginfo**);
