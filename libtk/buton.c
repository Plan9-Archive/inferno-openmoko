...
static const char*newbutton(TkTop*, int, __in_z const char*, char**);
static int  istransparent(Tk*);
static void tkvarchanged(Tk*, const char*, const char*);

const char*
tkbutton(TkTop *t, __in_z const char *arg, char **ret)
{
    return newbutton(t, TKbutton, arg, ret);
}

const char*
tkcheckbutton(TkTop *t, __in_z const char *arg, char **ret)
{
    return newbutton(t, TKcheckbutton, arg, ret);
}

const char*
tkradiobutton(TkTop *t, __in_z const char *arg, char **ret)
{
    return newbutton(t, TKradiobutton, arg, ret);
}

static const char*
newbutton(TkTop *t, int btype, __in_z const char *arg, char **ret)
{
    Tk *tk;
    const char *e;
    TkLabel *tkl;
...
const char*
tkbuttoninvoke(Tk *tk, __in_z_opt const char *arg, char **val)
{
    const char *e;
    USED(arg);
