...
NORETURN	disfault(void*, char*);
NORETURN	disinit(void*);
...
NORETURN	emuinit(void*);
int		eqchan(Chan*, Chan*, int);
int		eqqid(Qid, Qid);
//#define error(x) {print("%s:%d %s", __FILE__, __LINE__, __FUNCTION__); _error(x);}
NORETURN	error(char*);
NORETURN	errorf(char*, ...);
#pragma varargck argpos errorf 1
void		excinit(void);
NORETURN	exhausted(char*);
...
int		kproc(const char*, void (*)(void*), void*, KProcFlags);
int		kfgrpclose(Fgrp*, int);
void		ksetenv(char*, char*, int);
void		kstrcpy(char*, const char*, int);
void		kstrdup(char**, const char*);
long		latin1(uchar*, int);
NORETURN	libinit(char*);
void		links(void);
void		lock(Lock*);
